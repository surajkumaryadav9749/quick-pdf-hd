...
import { FiArchive, FiCamera, FiFileText, FiImage, FiMaximize } from "react-icons/fi";
...
const tools = [
  ...
  { title: "Document Scanner", description: "Scan documents into images", path: "/document-scanner", icon: FiCamera },
  { title: "Resize Image", description: "Resize images online", path: "/resize-image", icon: FiMaximize },
  { title: "WEBP to PDF", description: "Convert WEBP images to PDF", path: "/webp-to-pdf", icon: FiFileText },
];
